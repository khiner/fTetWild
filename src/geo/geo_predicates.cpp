...
//
// Trimmed to the three predicates fTetWild reaches -- orient_3d, orient_3dlifted_SOS and
// in_sphere_3d_SOS -- plus the exact cascade they bottom out in. The bodies are unchanged.
