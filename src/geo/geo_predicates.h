...
//
// Trimmed to the predicates fTetWild reaches. Geometric predicates built from arithmetic filters
// (Meyer and Pion), expansion arithmetic (Shewchuk) and simulation of simplicity (Edelsbrunner).
