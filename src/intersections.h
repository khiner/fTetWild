...
namespace floatTetWild {
    ...
    // Where the lines through seg1 and seg2 meet, as t1 along seg1 and t2 along seg2. False when
    ...
    // neither, so n - pos - neg is how many lie on the plane they were taken against.
    struct OriCounts { int pos, neg; };
